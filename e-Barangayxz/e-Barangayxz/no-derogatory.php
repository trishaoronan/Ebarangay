...
<head>
  ...
  <title>Certificate of No Derogatory Record</title>
...
<body class="doc-page">
  ...
  <section class="page-header mb-4">
    <div class="container">
      <h2 class="fw-bold mb-2 text-dark">Certificate of No Derogatory Record</h2>
      <p class="text-muted">Certification that the applicant has no adverse records, criminal cases, or unsettled disputes filed in the Barangay.</p>
    </div>
  </section>
  ...
  <div class="container pb-5">
    <div class="form-card">
      <form class="row g-3" id="noDerogatoryForm" method="post" action="submit_no_derogatory.php" enctype="multipart/form-data" data-backend="true">
        ...
        <div class="col-12 mt-3">
          <h5 class="section-title">Purpose & Declaration</h5>
        </div>
        <div class="col-12">
          <label class="form-label">Specific Purpose<span style="color: red;">*</span></label>
        ...
        <div class="col-12">
          <div class="form-check border rounded p-3 bg-light">
            <input class="form-check-input" type="checkbox" id="noRecord" required />
            <label class="form-check-label declaration-label" for="noRecord">
              I hereby declare that I have <u>NO PENDING CASE, COMPLAINT, OR DEROGATORY RECORD</u> filed against me in this Barangay or before the Lupong Tagapamayapa.
            </label>
          </div>
        </div>
        ...
        <!-- Document Upload -->
        <div class="col-12 mt-3">
          <h5 class="section-title">Required Document</h5>
          <p class="small text-muted">Upload a scanned copy of one (1) valid government ID. AI will verify your identity.</p>
        </div>
        <div class="col-md-6">
  ...
  <script>
    initializeNameValidation('noDerogatoryForm');
    // Initialize ID validation
    if (window.IdValidation) window.IdValidation.initialize('noDerogatoryForm');
    ...
    document.addEventListener('DOMContentLoaded', function() {
      if (typeof validateField === 'function' && typeof isPurposeValid === 'function') {
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content border-0 shadow-lg rounded-4">
        ...
        <div class="modal-body text-center py-5">
          ...
          <p class="text-muted mb-0" id="successMessage">Your Certificate of No Derogatory Record request has been submitted successfully. Verification will be conducted, and you will be notified when the certificate is ready.</p>
        </div>
  ...
  <script>
    // Intercept form submission and use backend message in success modal
    document.addEventListener('DOMContentLoaded', function () {
      const form = document.getElementById('noDerogatoryForm');
      ...
      form.addEventListener('submit', async function (e) {
        ...
        try {
          const response = await fetch('submit_no_derogatory.php', { method: 'POST', body: formData });
          const data = await response.json();

          if (data.success) {
            const defaultMsg = 'Your Certificate of No Derogatory Record request has been submitted successfully. Verification will be conducted, and you will be notified when the certificate is ready.';
            if (successMessageEl) {
