...
<head>
  ...
  <title>Low Income Certificate Request</title>
...
<body class="doc-page">
  ...
  <section class="page-header mb-4">
    <div class="container">
      <h2 class="fw-bold mb-2 text-dark">Barangay Low-Income Certificate Request</h2>
      <p class="text-muted">Please fill out the form accurately to request a certificate verifying your low-income status for social programs or financial assistance.</p>
    </div>
  </section>
  ...
  <div class="container pb-5">
    <div class="form-card">
      <form class="row g-3" id="lowIncomeForm" method="post" action="submit_low_income.php" enctype="multipart/form-data" data-backend="true">
        ...
        <div class="col-12 mt-3">
          <h5 class="section-title">Income & Household Details</h5>
        </div>
        <div class="col-md-6">
          <label class="form-label">Occupation / Source of Income<span style="color: red;">*</span></label>
          <input type="text" class="form-control" name="occupation" required />
        </div>
        <div class="col-md-3">
          <label class="form-label">Estimated Monthly Income (PHP)<span style="color: red;">*</span></label>
          <input type="text" class="form-control" id="monthlyIncome" name="monthlyIncome" placeholder="e.g., 5000" inputmode="numeric" pattern="^\d+(\.\d{2})?$" title="Enter numbers only with optional decimals" required />
          <small class="text-muted">Numbers only, will auto-format with decimals</small>
        </div>
        <div class="col-md-3">
          <label class="form-label">Total Household Members<span style="color: red;">*</span></label>
          <input type="number" class="form-control" name="householdMembers" min="1" required />
        </div>
        <div class="col-12">
          <label class="form-label">Purpose of Certificate<span style="color: red;">*</span></label>
        ...
        <div class="col-12 mt-3">
          ...
          <p class="text-muted">AI will verify your identity from the uploaded ID.</p>
        </div>
        <div class="col-md-6">
          <label class="form-label">Valid Government ID<span style="color: red;">*</span></label>
        ...
        <div class="col-md-6">
          <label class="form-label">Proof of Residency<span style="color: red;">*</span></label>
          <input type="file" class="form-control" name="proofResidency" accept="image/*,.pdf" required />
          <p class="small text-muted mt-1">Upload utility bill or similar showing your name and address.</p>
        </div>
  ...
  <script>
    initializeNameValidation('lowIncomeForm');
    // Initialize ID validation
    if (window.IdValidation) window.IdValidation.initialize('lowIncomeForm');
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const form = document.getElementById('lowIncomeForm');
        ...
        form.addEventListener('submit', async function(e) {
          ...
          try {
            ...
            if (result.success) {
              ...
              document.getElementById('successMessage').textContent = 'Your Low Income Certificate request has been submitted successfully. Verification will be conducted, and you will be notified when the document is ready.';
              modal.show();
      ...
      <div class="modal-content border-0 shadow-lg rounded-4">
        ...
        <div class="modal-body text-center py-5">
          ...
          <p class="text-muted mb-0" id="successMessage">
            Your Low Income Certificate request has been submitted successfully. Verification will be conducted, and you will be notified when the document is ready.
          </p>
        </div>
